<div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="py-2 ">
                                    ...
                                    <a href="" class="btn btn-success w-100"> More</a>
                                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @forelse ($products as $item)
                    <div class="col-lg-4">
                        <div class="card">
                            <img src="{{ asset('assets/uploads/'.$item->image) }}" style="height:300px;" class="card-img" alt="">
                            <div class="card-body">
                                <h5 class="card-title">{{ $item->name }}</h5>
    ...
    <section class="py-5 bg-dark text-light">
        <div class="container">
            <h4 class="text-center text-uppercase fw-bold">Feedback</h4>
           <div class="d-flex justify-content-center">
            <p class="px-2 col-lg-7" >Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis voluptate tempore aperiam tempora
                consequuntur placeat quos adipisci, ipsa sint nobis quas dicta numquam magni suscipit eos nostrum velit
                facere libero.</p>
           </div>
            <div class="row">
